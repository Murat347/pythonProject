...
multi_num(4.5, 5.666)
# multi multi_num(4.5, 5.666, 34) # TypeError: multi_num() takes 2 positional arguments but 3 were given
...
swap(546, 1234)
# swapping the values w/o using a variable
print("______")
num1 = 'number one'
num2 = 'number two'
print(num1,"---", num2)
